	...
	window.addEventListener("load", () => {
		...
		selectBtn.forEach(btn => {
			btn.addEventListener("click", e=> {
				...
				localStorage.setItem("movieNum", movienum);
			...
			<div class="recent-img-group-1">
				<c:forEach var="item" items="${list}">
					...
					<div class="recent-img-box">
						...
						<div class="img-animate select-btn" data-movienum ="${item.movieNum}">
						...
						<div class="text-area">
							...
							<div class="btns">
								<button data-movienum ="${item.movieNum}" class="select-btn reserve-btn">적용하기</button>
							</div>
						</div>
					</div>
				</c:forEach>
