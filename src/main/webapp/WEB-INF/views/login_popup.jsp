	...
	<main class="container">
		...
		<div class="login-div">
			...
			<form id="login-form" method="post">
				...
				<div class="btn-group">
					<div><button class="login-btn" type="submit"><span>LOGIN</span></button></div>
					<div><button type="button" class="back-btn" onclick="location.href='javascript:self.close()'"><span>BACK</span></button></div>
				</div>
